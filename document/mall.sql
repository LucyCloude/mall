...
INSERT INTO `cms_prefrence_area_product_relation` VALUES (26, 1, 38);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (27, 1, 39);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (28, 1, 40);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (29, 1, 41);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (30, 1, 42);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (31, 1, 43);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (32, 1, 45);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (33, 2, 45);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (34, 1, 26);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (35, 3, 26);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (48, 1, 47);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (49, 2, 47);
INSERT INTO `cms_prefrence_area_product_relation` VALUES (50, 3, 47);
...
CREATE TABLE `cms_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '专题表' ROW_FORMAT = Compact;
...
CREATE TABLE `cms_subject_category`  (
  ...
  `sort` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '专题分类表' ROW_FORMAT = Compact;
...
INSERT INTO `cms_subject_product_relation` VALUES (40, 1, 38);
INSERT INTO `cms_subject_product_relation` VALUES (41, 1, 39);
INSERT INTO `cms_subject_product_relation` VALUES (42, 1, 40);
INSERT INTO `cms_subject_product_relation` VALUES (43, 1, 41);
INSERT INTO `cms_subject_product_relation` VALUES (44, 1, 42);
INSERT INTO `cms_subject_product_relation` VALUES (45, 1, 43);
INSERT INTO `cms_subject_product_relation` VALUES (46, 1, 45);
INSERT INTO `cms_subject_product_relation` VALUES (47, 2, 45);
INSERT INTO `cms_subject_product_relation` VALUES (48, 2, 26);
INSERT INTO `cms_subject_product_relation` VALUES (49, 3, 26);
INSERT INTO `cms_subject_product_relation` VALUES (84, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (85, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (86, 2, 47);
INSERT INTO `cms_subject_product_relation` VALUES (87, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (88, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (89, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (90, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (91, 13, 47);
INSERT INTO `cms_subject_product_relation` VALUES (92, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (93, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (94, 2, 47);
INSERT INTO `cms_subject_product_relation` VALUES (95, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (96, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (97, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (98, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (99, 13, 47);
INSERT INTO `cms_subject_product_relation` VALUES (100, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (101, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (102, 2, 47);
INSERT INTO `cms_subject_product_relation` VALUES (103, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (104, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (105, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (106, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (107, 13, 47);
INSERT INTO `cms_subject_product_relation` VALUES (108, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (109, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (110, 2, 47);
INSERT INTO `cms_subject_product_relation` VALUES (111, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (112, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (113, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (114, 1, 47);
INSERT INTO `cms_subject_product_relation` VALUES (115, 13, 47);
...
CREATE TABLE `oms_cart_item`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车表' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_company_address`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公司收发货地址表' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_order_item`  (
  ...
  `product_attr` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品销售属性:[{\"key\":\"颜色\",\"value\":\"颜色\"},{\"key\":\"容量\",\"value\":\"4G\"}]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单中所包含的商品' ROW_FORMAT = Compact;
...
CREATE TABLE `oms_order_return_reason`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退货原因表' ROW_FORMAT = Compact;
...
CREATE TABLE `pms_brand`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌表' ROW_FORMAT = Compact;
...
INSERT INTO `pms_member_price` VALUES (222, 45, 1, 100.00, '黄金会员');
INSERT INTO `pms_member_price` VALUES (223, 45, 2, 90.00, '白金会员');
INSERT INTO `pms_member_price` VALUES (224, 45, 3, 80.00, '钻石会员');
INSERT INTO `pms_member_price` VALUES (225, 45, 4, 120.00, '普通会员');
INSERT INTO `pms_member_price` VALUES (234, 26, 1, 3500.00, '黄金会员');
INSERT INTO `pms_member_price` VALUES (235, 26, 2, 3400.00, '白金会员');
INSERT INTO `pms_member_price` VALUES (236, 26, 3, 3300.00, '钻石会员');
INSERT INTO `pms_member_price` VALUES (273, 47, 1, 1.00, '黄金会员');
INSERT INTO `pms_member_price` VALUES (274, 47, 2, 11.00, '白金会员');
INSERT INTO `pms_member_price` VALUES (275, 47, 3, 111.00, '钻石会员');
INSERT INTO `pms_member_price` VALUES (276, 47, 4, 1111.00, '普通会员');
INSERT INTO `pms_member_price` VALUES (285, 46, 1, 11.00, '黄金会员');
INSERT INTO `pms_member_price` VALUES (286, 46, 2, 11.00, '白金会员');
INSERT INTO `pms_member_price` VALUES (287, 46, 3, 11.00, '钻石会员');
INSERT INTO `pms_member_price` VALUES (288, 46, 4, 11.00, '普通会员');
...
CREATE TABLE `pms_product`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品信息' ROW_FORMAT = Compact;
...
INSERT INTO `pms_product` VALUES (27, 6, 19, 0, 3, '小米8 全面屏游戏智能手机 6GB+64GB 黑色 全网通4G 双卡双待', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/xiaomi.jpg', '7437788', 0, 0, 1, 0, 0, 0, 0, 2699.00, NULL, 2699, 2699, 0, '骁龙845处理器，红外人脸解锁，AI变焦双摄，AI语音助手小米6X低至1299，点击抢购', '小米8 全面屏游戏智能手机 6GB+64GB 黑色 全网通4G 双卡双待', 2699.00, 100, 0, '', 0.00, 0, '', '', '', '', '', '', '<p><img class=\"wscnph\" src=\"http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5b2254e8N414e6d3a.jpg\" width=\"500\" /></p>', '', NULL, NULL, 0, 3, '小米', '手机通讯');
INSERT INTO `pms_product` VALUES (28, 6, 19, 0, 3, '小米 红米5A 全网通版 3GB+32GB 香槟金 移动联通电信4G手机 双卡双待', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5a9d248cN071f4959.jpg', '7437789', 0, 0, 1, 0, 0, 0, 0, 649.00, NULL, 649, 649, 0, '8天超长待机，137g轻巧机身，高通骁龙处理器小米6X低至1299，点击抢购', '', 649.00, 100, 0, '', 0.00, 0, '', '', '', '', '', '', '', '', NULL, NULL, 0, 4, '小米', '手机通讯');
INSERT INTO `pms_product` VALUES (29, 51, 19, 0, 3, 'Apple iPhone 8 Plus 64GB 红色特别版 移动联通电信4G手机', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5acc5248N6a5f81cd.jpg', '7437799', 0, 0, 1, 0, 0, 0, 0, 5499.00, NULL, 5499, 5499, 0, '【限时限量抢购】Apple产品年中狂欢节，好物尽享，美在智慧！速来 >> 勾选[保障服务][原厂保2年]，获得AppleCare+全方位服务计划，原厂延保售后无忧。', '', 5499.00, 100, 0, '', 0.00, 0, '', '', '', '', '', '', '', '', NULL, NULL, 0, 0, '苹果', '手机通讯');
...
INSERT INTO `pms_product` VALUES (37, 4, 7, 0, 2, '测试1', '', '测试1', 1, 1, 1, 1, 0, 1, 0, 20.00, NULL, 1, 1, 2, '测试1', '测试1', 20.00, 11, 0, '1', 22.00, 1, '1,2,3', '测试1', '测试1', '', '测试1', '测试1', '<p>测试1</p>', '', NULL, NULL, 0, 0, '格力', '外套');
INSERT INTO `pms_product` VALUES (38, 6, 7, 0, 1, '111', '', '111', 1, 0, 0, 0, 0, 1, 0, 1.00, NULL, 1, 1, 1, '1111', '111', 1.00, 1, 0, '1', 1.00, 0, '', '1', '1', '', '1', '1', '<p>11</p>', '', NULL, NULL, 0, 0, '小米', '外套');
INSERT INTO `pms_product` VALUES (39, 6, 7, 0, 1, '111', '', '111', 1, 0, 0, 0, 0, 1, 0, 1.00, NULL, 1, 1, 1, '1111', '111', 1.00, 1, 0, '1', 1.00, 0, '', '1', '1', '', '1', '1', '<p>11</p>', '', NULL, NULL, 0, 0, '小米', '外套');
...
CREATE TABLE `pms_product_attribute`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品属性参数表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_product_attribute
-- ----------------------------
INSERT INTO `pms_product_attribute` VALUES (1, 1, '尺寸', 2, 1, 'M,X,XL,2XL,3XL,4XL', 1, 0, 0, 0, 1, 0);
INSERT INTO `pms_product_attribute` VALUES (7, 1, '颜色', 2, 1, '黑色,红色,白色,粉色', 100, 0, 0, 0, 1, 0);
INSERT INTO `pms_product_attribute` VALUES (13, 0, '上市年份', 1, 1, '2016年,2017年,2018年,2019年,2020年', 0, 0, 0, 0, 0, 1);
INSERT INTO `pms_product_attribute` VALUES (14, 0, '上市年份1', 1, 1, '2016年,2017年,2018年,2019年,2020年', 0, 0, 0, 0, 0, 1);
INSERT INTO `pms_product_attribute` VALUES (15, 0, '上市年份2', 1, 1, '2016年,2017年,2018年,2019年,2020年', 0, 0, 0, 0, 0, 1);
INSERT INTO `pms_product_attribute` VALUES (16, 0, '上市年份3', 1, 1, '2016年,2017年,2018年,2019年,2020年', 0, 0, 0, 0, 0, 1);
INSERT INTO `pms_product_attribute` VALUES (17, 0, '上市年份4', 1, 1, '2016年,2017年,2018年,2019年,2020年', 0, 0, 0, 0, 0, 1);
INSERT INTO `pms_product_attribute` VALUES (18, 0, '上市年份5', 1, 1, '2016年,2017年,2018年,2019年,2020年', 0, 0, 0, 0, 0, 1);
...
INSERT INTO `pms_product_attribute` VALUES (24, 1, '商品编号', 1, 0, '11111', 0, 0, 1, 0, 0, 1);
...
INSERT INTO `pms_product_attribute` VALUES (38, 1, '上市时间', 1, 1, '2020年秋,2020年冬,2020年春,2020年夏', 0, 0, 0, 0, 0, 1);
...
INSERT INTO `pms_product_attribute` VALUES (42, 2, '上市时间', 0, 1, '2020年春,2020年夏', 0, 0, 0, 0, 0, 1);
...
CREATE TABLE `pms_product_attribute_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品属性分类表' ROW_FORMAT = Compact;
...
INSERT INTO `pms_product_attribute_value` VALUES (228, 37, 35, '测试1');
INSERT INTO `pms_product_attribute_value` VALUES (229, 37, 32, '老年');
INSERT INTO `pms_product_attribute_value` VALUES (230, 37, 33, '嘻哈风格');
INSERT INTO `pms_product_attribute_value` VALUES (231, 37, 41, '居家');
INSERT INTO `pms_product_attribute_value` VALUES (232, 37, 42, '2018年春');
INSERT INTO `pms_product_attribute_value` VALUES (233, 38, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (234, 38, 25, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (235, 38, 37, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (236, 38, 38, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (237, 38, 39, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (238, 39, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (239, 39, 25, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (240, 39, 37, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (241, 39, 38, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (242, 39, 39, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (243, 40, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (244, 40, 25, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (245, 40, 37, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (246, 40, 38, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (247, 40, 39, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (248, 41, 32, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (249, 41, 33, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (250, 41, 41, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (251, 41, 42, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (252, 42, 32, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (253, 42, 33, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (254, 42, 41, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (255, 42, 42, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (256, 43, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (257, 43, 25, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (258, 43, 37, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (259, 43, 38, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (260, 43, 39, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (261, 45, 7, '金色');
INSERT INTO `pms_product_attribute_value` VALUES (262, 45, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (263, 45, 25, '春季');
INSERT INTO `pms_product_attribute_value` VALUES (264, 45, 37, '儿童');
INSERT INTO `pms_product_attribute_value` VALUES (265, 45, 38, '2018年夏');
INSERT INTO `pms_product_attribute_value` VALUES (266, 45, 39, '长袖');
INSERT INTO `pms_product_attribute_value` VALUES (267, 26, 43, '金色,银色');
INSERT INTO `pms_product_attribute_value` VALUES (268, 26, 45, '5.0');
INSERT INTO `pms_product_attribute_value` VALUES (269, 26, 46, '4G');
INSERT INTO `pms_product_attribute_value` VALUES (270, 26, 47, 'Android');
INSERT INTO `pms_product_attribute_value` VALUES (271, 26, 48, '3000');
INSERT INTO `pms_product_attribute_value` VALUES (320, 47, 7, '黑色');
INSERT INTO `pms_product_attribute_value` VALUES (321, 47, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (322, 47, 25, '春季');
INSERT INTO `pms_product_attribute_value` VALUES (323, 47, 37, '儿童');
INSERT INTO `pms_product_attribute_value` VALUES (324, 47, 38, '2020年秋');
INSERT INTO `pms_product_attribute_value` VALUES (325, 47, 39, '短袖');
INSERT INTO `pms_product_attribute_value` VALUES (332, 46, 7, '黑色');
INSERT INTO `pms_product_attribute_value` VALUES (333, 46, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (334, 46, 25, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (335, 46, 37, '儿童');
INSERT INTO `pms_product_attribute_value` VALUES (336, 46, 38, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (337, 46, 39, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (338, 48, 7, '黑色');
INSERT INTO `pms_product_attribute_value` VALUES (339, 48, 24, NULL);
INSERT INTO `pms_product_attribute_value` VALUES (340, 48, 25, '春季');
...
CREATE TABLE `pms_product_category_attribute_relation`  (
  ...
  `product_attribute_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品的分类和属性的关系表，用于设置分类筛选条件（只支持一级分类）' ROW_FORMAT = Compact;
...
INSERT INTO `pms_product_category_attribute_relation` VALUES (12, 52, 24);
INSERT INTO `pms_product_category_attribute_relation` VALUES (13, 52, 1);
...
INSERT INTO `pms_sku_stock` VALUES (110, 45, '202002090045001', 100.00, 100, NULL, 'M', '黑色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (111, 45, '202002090045002', 100.00, 100, NULL, 'M', '金色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (112, 45, '202002090045003', 100.00, 100, NULL, 'X', '黑色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (113, 45, '202002090045004', 100.00, 100, NULL, 'X', '金色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (114, 45, '202002090045005', 100.00, 100, NULL, 'XL', '黑色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (115, 45, '202002090045006', 100.00, 100, NULL, 'XL', '金色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (116, 26, '201806070026001', 3788.00, 499, NULL, '金色', '16G', NULL, 'http://server-test1.oss-cn-beijing.aliyuncs.com/images/20200212/dfdfdf.png', NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (117, 26, '201806070026002', 3999.00, 500, NULL, '金色', '32G', NULL, 'http://server-test1.oss-cn-beijing.aliyuncs.com/images/20200212/dfdfdf.png', NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (118, 26, '201806070026003', 3788.00, 500, NULL, '银色', '16G', NULL, 'http://server-test1.oss-cn-beijing.aliyuncs.com/images/20200212/fgf.jpg', NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (119, 26, '201806070026004', 3999.00, 500, NULL, '银色', '32G', NULL, 'http://server-test1.oss-cn-beijing.aliyuncs.com/images/20200212/fgf.jpg', NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (160, 47, '202002160047001', 1.00, 1, NULL, 'M', '黑色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (161, 47, '202002160047002', 1.00, 1, NULL, 'X', '黑色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (162, 47, '202002160047003', 1.00, 11, NULL, 'XL', '黑色', NULL, NULL, NULL, NULL, 0);
INSERT INTO `pms_sku_stock` VALUES (163, 47, '202002160047004', 1.00, 1, NULL, '2XL', '黑色', NULL, NULL, NULL, NULL, 0);
...
CREATE TABLE `sms_coupon_product_category_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券和产品分类关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_coupon_product_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券和产品的关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_flash_promotion`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '限时购表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_flash_promotion_product_relation`  (
  ...
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品限时购与商品关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_flash_promotion_session`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '限时购场次表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_home_brand`  (
  ...
  `sort` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页推荐品牌表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_home_new_product`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '新鲜好物表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_home_recommend_product`  (
  ...
  `sort` int(1) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '人气推荐商品表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_home_recommend_subject`  (
  ...
  `sort` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页推荐专题表' ROW_FORMAT = Compact;
...
INSERT INTO `ums_admin_login_log` VALUES (18, 3, '2020-02-01 19:56:40', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (19, 3, '2020-02-01 20:26:20', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (20, 3, '2020-02-01 20:33:16', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (21, 3, '2020-02-03 13:20:05', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (22, 3, '2020-02-05 13:39:57', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (23, 3, '2020-02-05 14:43:50', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (24, 3, '2020-02-05 14:47:29', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (25, 4, '2020-02-05 15:17:55', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (26, 4, '2020-02-05 15:18:07', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (27, 4, '2020-02-05 15:24:33', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (28, 3, '2020-02-05 16:38:30', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (29, 3, '2020-02-05 17:15:39', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (30, 3, '2020-02-05 19:39:43', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (31, 3, '2020-02-05 19:57:14', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (32, 3, '2020-02-05 20:00:46', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (33, 3, '2020-02-06 08:32:58', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (34, 3, '2020-02-06 15:24:24', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (35, 3, '2020-02-06 15:25:44', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (36, 3, '2020-02-06 16:09:02', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (37, 3, '2020-02-06 16:09:06', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (38, 3, '2020-02-06 16:09:21', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (39, 3, '2020-02-06 16:10:52', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (40, 3, '2020-02-06 16:11:22', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (41, 3, '2020-02-06 16:11:24', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (42, 3, '2020-02-06 16:11:57', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (43, 3, '2020-02-06 16:13:19', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (44, 3, '2020-02-06 16:14:14', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (45, 3, '2020-02-06 16:14:18', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (46, 3, '2020-02-06 16:14:54', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (47, 3, '2020-02-06 16:16:19', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (48, 3, '2020-02-06 16:23:20', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (49, 3, '2020-02-06 16:23:22', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (50, 3, '2020-02-06 16:24:00', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (51, 3, '2020-02-06 16:29:25', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (52, 3, '2020-02-06 16:30:09', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (53, 3, '2020-02-06 17:41:18', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (54, 3, '2020-02-06 17:45:07', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (55, 3, '2020-02-06 18:48:48', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (56, 4, '2020-02-07 10:05:33', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (57, 3, '2020-02-07 10:06:31', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (58, 4, '2020-02-07 10:07:29', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (59, 4, '2020-02-07 10:08:52', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (60, 3, '2020-02-07 17:05:06', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (61, 3, '2020-02-08 13:24:08', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (62, 3, '2020-02-09 14:23:19', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (63, 3, '2020-02-13 16:53:22', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (64, 3, '2020-02-13 17:09:29', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (65, 3, '2020-02-16 16:46:05', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (66, 3, '2020-02-16 16:55:29', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (67, 3, '2020-02-17 10:34:30', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (68, 3, '2020-02-19 15:29:40', '0:0:0:0:0:0:0:1', NULL, NULL);
...
CREATE TABLE `ums_resource_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源分类表' ROW_FORMAT = Compact;
